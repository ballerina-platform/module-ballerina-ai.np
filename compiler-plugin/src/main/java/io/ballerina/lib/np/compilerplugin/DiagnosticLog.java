...
class DiagnosticLog {
    ...
    enum DiagnosticCode {
        ...
        NON_JSON_EXPECTED_TYPE_NOT_YET_SUPPORTED("NP_ERROR_003", "non.json.expected.type.not.yet.supported"),
        NON_JSON_TYPEDESC_ARGUMENT_NOT_YET_SUPPORTED("NP_ERROR_004", "non.json.typedesc.argument.not.yet.supported");
