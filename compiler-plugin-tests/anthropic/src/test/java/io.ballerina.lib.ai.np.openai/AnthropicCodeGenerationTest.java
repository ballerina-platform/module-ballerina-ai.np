...
public class AnthropicCodeGenerationTest extends AbstractCodeGenerationTest {
    ...
    public void testConstNaturalExpressionsInProject() throws IOException, InterruptedException {
        enqueueResponse("const-natural-expressions", "anthropic_const_natural_expr_response.json");
    ...
    public void testConstNaturalExpressionsInProjectWithRepair() throws IOException, InterruptedException {
        ...
        enqueueResponse(resDir, "anthropic_const_natural_expr_with_validation_failure_code_response.json");
        enqueueResponse(resDir, "anthropic_const_natural_expr_with_validation_failure_repair_response.json");
    ...
    public void testCodeFunction() throws IOException, InterruptedException {
        ...
        enqueueResponse(resDir, "anthropic_code_function_code_response.json");
        enqueueResponse(resDir, "anthropic_code_function_repair_response.json");
    ...
    public void testCodeFunctionWithValidation() throws IOException, InterruptedException {
        ...
        enqueueResponse(resDir, "anthropic_code_function_with_validation_code_response.json");
        enqueueResponse(resDir, "anthropic_code_function_with_validation_repair_response.json");
